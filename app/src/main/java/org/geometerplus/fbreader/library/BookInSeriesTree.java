...
public final class BookInSeriesTree extends BookTree {
	BookInSeriesTree(IBookCollection collection, PluginCollection pluginCollection, org.geometerplus.fbreader.book.Book book) {
		super(collection, pluginCollection, book);
	}

	BookInSeriesTree(LibraryTree parent, org.geometerplus.fbreader.book.Book book, int position) {
