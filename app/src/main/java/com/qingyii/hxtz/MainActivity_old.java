...
import com.qingyii.hxtz.util.NetworkImageHolderView;
...
//                    Toast.makeText(this, "敬请期待", Toast.LENGTH_LONG).show();
                        if (MyApplication.userUtil.getId() != 0)
                            //Intent it=new Intent(MoreActivity.this,KaoChangTypesActivity.class);
...
//                    Intent intent = new Intent(MoreActivity.this, GuanLiActivity.class);
...
//              Intent intnet=new Intent(MoreActivity.this,SpannableStringActivity.class);
