package com.qingyii.hxtz.zhf.android_viewflow;
...
public class ViewFlow extends AdapterView<Adapter> {
    ...
    public static interface ViewSwitchListener {
        ...
        /**
         * This method is called when a new NotifyView has been scrolled to.
         *
        ...
        handler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                if (getChildCount() > 0) {
	            	...
	            	/*if(getChildCount()>0){
	            		if(getChildCount()==(mCurrentScreen+1)){
	            			snapToScreen(0);  
	 		                Message message = handler.obtainMessage(0);  
	 		                sendMessageDelayed(message, 3*1000);
	 		               mCurrentScreen=0;
	            		}else{
			                Message message = handler.obtainMessage(0);  
			                sendMessageDelayed(message, 3*1000);
