...
import com.qingyii.hxtz.CropImageActivity;
...
public class AddPhotoActivity extends AbBaseActivity {
    ...
    /* ProgressBar进度控制 */
    /**
     * AbHorizontalProgressBar 失效，注释相关
     */
//    private AbHorizontalProgressBar mAbProgressBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //默认
        mPhotoList.add(String.valueOf(R.mipmap.cam_photo));
...
//                    mAvatarView = mInflater.inflate(R.layout.choose_avatar, null);
                    mAvatarView = View.inflate(AddPhotoActivity.this, R.layout.choose_avatar, null);
                    ...
                    mViewHolder.mImageView2.setBackgroundResource(R.mipmap.photo_select);
                }
            }
...
//                mAbProgressBar.setProgress(progress);
                ...
                mAlertDialog = AbDialogUtil.showAlertDialog(v);
