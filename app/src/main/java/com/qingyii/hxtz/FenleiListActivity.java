...
import com.qingyii.hxtz.adapter.FenleiItemAdapter;
 ...
 * 分类列表界面
 */
public class FenleiListActivity extends AbBaseActivity {
    private ListView mListView = null;
    private AbPullToRefreshView mAbPullToRefreshView = null;
    private FenleiItemAdapter adapter;
        ...
        handler = new Handler(new Callback() {
            ...
            public boolean handleMessage(Message msg) {
                if (msg.what == 1) {
                    ...
                    Toast.makeText(FenleiListActivity.this, "获取数据失败", Toast.LENGTH_SHORT).show();
                } else if (msg.what == 5) {
                    Toast.makeText(FenleiListActivity.this, "已是最新数据", Toast.LENGTH_SHORT).show();
                }
...
//        fenLeiBookList(page, pagesize);
    ...
    private void initUI() {
        ...
        adapter = new FenleiItemAdapter(FenleiListActivity.this, list);
        ...
        mListView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent it = new Intent(FenleiListActivity.this, shujixiangqingActivity.class);
