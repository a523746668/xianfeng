...
import com.qingyii.hxt.pojo.JPusheExtras;
...
//            Log.e("推送 打开页面", "HomeActivity 1");
            intent.setClass(context, HomeActivity.class);  //去到哪个Activity
        } else {
...
//        Intent intent_service = new Intent(context, HomeActivity.class);
