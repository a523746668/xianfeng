...
import com.qingyii.hxt.adapter.neiKanXqAdapter;
import com.qingyii.hxt.httpway.NKUpload;
import com.qingyii.hxt.neiKanXq1;
 ...
 */
public class neiKanXqJPush extends AbBaseActivity {
...
//                }
            ...
            if (msg.what == 2) {
                Toast.makeText(neiKanXqJPush.this, "已是最新数据", Toast.LENGTH_SHORT).show();
//                    mDialogFragment.dismiss();
                shapeLoadingDialog.dismiss();
            } else if (msg.what == 0) {
                Toast.makeText(neiKanXqJPush.this, "获取数据异常", Toast.LENGTH_SHORT).show();
            } else if (msg.what == 1) {
...
//        magazine = (Magazine) getIntent().getSerializableExtra("Magazine");
        sDataBeanID = getIntent().getIntExtra("ID", 0);
...
//        tv_title.setText(magazine.getMagazinename());
        ...
        adapter = new neiKanXqAdapter(neiKanXqJPush.this, list);
        ...
        mListView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent it = new Intent(neiKanXqJPush.this, neiKanXq1.class);
...
//        getNeikanQishuList(1, pagesize);
        ...
        nkUpload.NKAxpect(this, adapter, sDataBeanID, 0, list, handler);
    }
...
//        getNeikanQishuList(page, pagesize);
        NKUpload nkUpload = NKUpload.getNKUpload();
        if (list.size() > 0)
            nkUpload.NKAxpect(this, adapter, sDataBeanID, list.get(list.size() - 1).getId(), list, handler);
        else
