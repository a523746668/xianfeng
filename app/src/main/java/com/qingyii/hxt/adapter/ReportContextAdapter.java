...
public class ReportContextAdapter extends BaseAdapter {
    private Activity activity;
    private List<WaitAffirmList.DataBean.ChecklogsBean> wChecklogsBeanList;

    public ReportContextAdapter(Activity activity, List<WaitAffirmList.DataBean.ChecklogsBean> wChecklogsBeanList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        try {
            WaitAffirmList.DataBean.ChecklogsBean wDataBean = wChecklogsBeanList.get(position);
