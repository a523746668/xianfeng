...
public class ImageShowAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            SquareImage mImageView1 = new SquareImage(mContext);
            mImageView1.setScaleType(ScaleType.CENTER_CROP);
            ImageView mImageView2 = new ImageView(mContext);
            mImageView2.setScaleType(ScaleType.CENTER_CROP);
            ...
            lp1.gravity = Gravity.FILL | Gravity.FILL;
            ...
            mRelativeLayout.setBackgroundColor(mContext.getResources().getColor(R.color.cadetblue));
...
//            Bitmap bitmap = AbImageCache.getInstance().getBitmap(imagePath);
            if (abImageCache == null)
                abImageCache = new AbImageCacheImpl(this.mContext);
