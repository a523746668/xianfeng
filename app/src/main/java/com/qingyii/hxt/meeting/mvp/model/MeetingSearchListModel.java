...
import com.qingyii.hxt.base.mvp.api.cache.CommonCache;
...
@ActivityScope
public class MeetingSearchListModel extends BaseModel implements CommonContract.MeetingSearchListModel {
    private Gson mGson;
    private Application mApplication;

    @Inject
    public MeetingSearchListModel(IRepositoryManager repositoryManager, Gson gson, Application application) {
    ...
    @Override
    public Observable<MeetingList> getMeetingSearchList(int lastIdQueried, String direction, boolean update) {
