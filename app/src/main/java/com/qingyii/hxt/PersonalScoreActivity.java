...
import com.qingyii.hxt.adapter.PersonalScoreAdapter;
...
import com.qingyii.hxt.pojo.Score;
...
public class PersonalScoreActivity extends AbBaseActivity {
        ...
        handler = new Handler(new Callback() {
            ...
            public boolean handleMessage(Message msg) {
                ...
                if (msg.what == 1) {
                    ...
                    Toast.makeText(PersonalScoreActivity.this, "数据获取异常！", Toast.LENGTH_SHORT).show();
                } else if (msg.what == 5) {
                    Toast.makeText(PersonalScoreActivity.this, "已是最新数据！", Toast.LENGTH_SHORT).show();
                }
...
//		});
    ...
    private void initUI() {
        ...
        if (EmptyUtil.IsNotEmpty(score.getUsername())) {
            personalscore_title.setText(score.getName() + "的考试成绩");
        }
    ...
    private void getscorelist(int mypage, int mypagesize) {
        ...
        try {
            ...
            jsonObject.put("userid", score.getUserid());
            byte[] bytes;
            ByteArrayEntity arrayEntity = null;
            try {
                bytes = jsonObject.toString().getBytes("utf-8");
                arrayEntity = new ByteArrayEntity(bytes);
                YzyHttpClient.post(PersonalScoreActivity.this, HttpUrlConfig.queryScoreAllList, arrayEntity, new AsyncHttpResponseHandler() {
                    ...
                    public void onSuccess(int statusCode, String content) {
                        ...
                        if (statusCode == 499) {
                            Toast.makeText(PersonalScoreActivity.this, CacheUtil.logout, Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(PersonalScoreActivity.this, LoginActivity.class);
