...
public class ResultpostionPresenter {

    private Context context;
    private Resultpotionview resultview;

    public ResultpostionPresenter(Context context, Resultpotionview resultview) {
        this.context = context;
        this.resultview = resultview;
    }

    public void getdata( int industryid){
    ...
    //拿到viewpager的数据
    public void getdvpdata( ArrayList<TaskTitlebean.DataBean.LibsystemBean> list,int industryid){
