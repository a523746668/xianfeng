...
(function () {
  ...
  var bookData = Monocle.bookData({
    components: [
      'file:///android_assetcomponents/1.html',
      'file:///android_assetcomponents/2.html',
      'file:///android_assetcomponents/3.html',
      'file:///android_assetcomponents/toc.html'
    ],
    chapters:[
      {
        title: "The Signal Man",
        src: "file:///android_assetcomponents/1.html"
      },
      {
        title: "The Haunted House",
        src: "file:///android_assetcomponents/2.html",
        children: [
          {
            title: "Chapter I — The Mortals in the House",
            src: "file:///android_assetcomponents/2.html#p2ch1"
          },
          {
            title: "Chapter II — The Ghost in Master B.'s Room",
            src: "file:///android_assetcomponents/2.html#p2ch2"
          }
        ]
      },
      {
        title: "The Trial for Murder",
        src: "file:///android_assetcomponents/3.html"
      }
    ],
    metadata: {
