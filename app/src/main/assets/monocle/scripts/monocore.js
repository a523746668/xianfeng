...
Monocle.Panels.Magic = function (flipper, evtCallbacks) {
  ...
  function cmptContactEnd(evt) {
    ...
    if(p.action.startX>=centerWidth.begin && p.action.startX<=centerWidth.end){
    	dispatch('monocle:panel:tapcenter', evt)
    	return;
    }
  ...
  function getCenterWidth(){
    var middle = p.parts.reader.offsetWidth / 2;
    var middleObj = {};
    middleObj.begin = middle-20;
    middleObj.end = middle+20;
  	return middleObj;
  }
